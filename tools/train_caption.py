...
from mmdet.apis import set_random_seed, train_detector, train_captioner
...
def parse_args():
    ...
    parser.add_argument(
        '--validate',
        action='store_true',
        help='whether to evaluate the checkpoint by val set during training')
    parser.add_argument(
        '--validate_test',
        action='store_true',
        help='whether to evaluate the checkpoint by test set during training')
