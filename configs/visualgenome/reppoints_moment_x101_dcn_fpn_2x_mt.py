...
model = dict(
    ...
    pretrained='checkpoints/mmlab/imnet/resnext101_32x4d-a5af3160.pth',
    backbone=dict(
        type='ResNeXt',
        depth=101,
        groups=32,
...
log_level = 'INFO'
work_dir = './experiments/VG_Detection_reppoints_moment_x101_dcn_fpn_2x_mt'
load_from = None
resume_from = './experiments/VG_Detection_reppoints_moment_x101_dcn_fpn_2x_mt/latest.pth'
