...
log_level = 'INFO'
work_dir = './experiments/VG_MASKTRANS_Detection_faster_rcnn_x101_64x4d_fpn_1x'
load_from = None
resume_from = None  # './experiments/VG_MASKTRANS_Detection_faster_rcnn_x101_64x4d_fpn_1x/latest.pth'
workflow = [('train', 1)]
