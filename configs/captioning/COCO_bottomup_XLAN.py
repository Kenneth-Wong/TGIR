...
model = dict(
    ...
    head_config=dict(
        ...
        ########## bilinear ##########
        bilinear_dim=1024, # this is the flag for whether to use bilinear
        act='CeLU',
...
log_level = 'INFO'
work_dir = './work_dirs/COCO_bottomup_XLAN/'
evaluation = dict(interval=1, beam_size=3, greedy_decode=True)
load_from = None
resume_from = None
...
log_config = dict(
    ...
    hooks=[
        ...
        #      init_kwargs=dict(
        #          project='captioning_COCO_bottomup_XLAN',
        #          name='train',
