...
model = dict(
    ...
    relation_head=dict(
        ...
        head_config=dict(
            ...
            # embed the tree depth
            embed_tree_depth=True,
            num_embed_depth=4,
            depth_embed_dim=1024,
            loss_embed_tree=dict(
...
log_level = 'INFO'
work_dir = './work_dirs/VGKR_PredCls_heth_faster_rcnn_x101_64x4d_fpn_1x'
