...
model = dict(
    ...
    relation_head=dict(
        ...
        relation_ranker=dict(
            type='LSTMRanker',  # LinearRanker-KLDiv 10;  LSTMRanker-KLdiv 1000;  TransformerRanker 1000
            comb_factor=0.1,
            area_form='rect',
            loss=dict(
...
log_level = 'INFO'
work_dir = './new_experiments/VGCOCO_PredCls_motif_wS19_lstmranker_faster_rcnn_x101_64x4d_fpn_1x'
