...
train_pipeline = [
    ...
    dict(type='LoadAnnotations', with_bbox=True, with_attr=True),
...
log_level = 'INFO'
work_dir = './experiments/VGGN_Detection_faster_rcnn_x101_64x4d_fpn_1x'
load_from = 'experiments/VGGN_Detection_faster_rcnn_x101_64x4d_fpn_1x/latest.pth'
resume_from = None #'experiments/VGGN_Detection_faster_rcnn_x101_64x4d_fpn_1x/latest.pth'
