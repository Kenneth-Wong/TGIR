...
evaluation = dict(interval=4, metric='predcls', relation_mode=True, classwise=True)
# optimizer
...
log_level = 'INFO'
work_dir = './new_experiments/VG_PredCls_motif_Xstat_mask_X_rcnn_x101_64x4d_fpn_1x'
