...
evaluation = dict(interval=5, metric='predcls', relation_mode=True, classwise=True)
# optimizer
...
log_level = 'INFO'
work_dir = './new_experiments/VG_PredCls_heth_area_gnn8head_dot_mask_X_rcnn_x101_64x4d_fpn_1x'
