"""
This config file is the reimplementation for:
...
dataset_config.update(dict(object_cache=data_root + 'VG_object_statistics.cache'))
model = dict(
    type='MaskRCNN',
...
log_level = 'INFO'
work_dir = './experiments/VG_PredCls_sokt_mask_X_rcnn_x101_64x4d_fpn_1x'
