...
model = dict(
    ...
    relation_head=dict(
        ...
        head_config=dict(
            ...
            causal_effect_analysis=True,
            causal_fusion_type='gate',
            causal_context_layer='motifs',
            causal_effect_type='TDE',
            causal_spatial_for_vision=False,
            separate_spatial=False),  # keep consistent with the relation_roi_extractor
        bbox_roi_extractor=dict(
...
test_cfg = dict(
    ...
    rcnn=dict(
        ...
        max_per_img=80,  # Follow the setting in TDE, 80 Bboxes are selected.
        mask_thr_binary=0.5,
...
evaluation = dict(interval=1, metric='sgcls', relation_mode=True, classwise=True)
# optimizer
...
log_level = 'INFO'
work_dir = './new_experiments/VG_SgCls_gatecausalmotif_mask_X_rcnn_x101_64x4d_fpn_1x'
