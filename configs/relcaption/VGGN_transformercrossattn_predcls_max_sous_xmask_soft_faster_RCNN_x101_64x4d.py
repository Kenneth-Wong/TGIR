...
model = dict(
    ...
    relcaption_head=dict(
        type='TransformerCrossAttnRelationalCaptionHead',
        ...
        head_config=dict(
            ...
            gather_attention='max',
            ipt_estimate='sous',
            soft_supervised=True,
            mask_obj_word=False,
        ...
        caption_config=dict(
            ...
            union_feat_config=dict(
                union_feats_dim=512,
                union_spatial_dim=64,
                union_feats_embed_dim=512,
                union_feats_semantic_dim=200,
...
optimizer = dict(type='SGD', lr=0.02, momentum=0.9, weight_decay=0.0001,
                 freeze_modules=['backbone', 'neck', 'rpn_head', 'bbox_head', 'attr_head', 'relcaption_head'],
                 required_grad_modules=['relcaption_head.global_feat_embed', 'relcaption_head.local_feat_embed',
                                        'relcaption_head.semantic_embedding'])
...
log_level = 'INFO'
work_dir = './experiments/iccv21/VGGN_transformercrossattn_predcls_max_sous_xmask_soft_faster_rcnn_x101_64x4d_fpn_1x'
load_from = 'experiments/iccv21/VGGN_transformercrossattn_predcls_Xcroatt_relcap0.7_faster_rcnn_x101_64x4d_fpn_1x/epoch_15.pth'
resume_from = None
