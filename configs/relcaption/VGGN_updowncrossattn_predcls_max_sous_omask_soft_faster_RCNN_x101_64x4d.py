...
log_level = 'INFO'
work_dir = './experiments/iccv21/VGGN_updowncrossattn_predcls_max_sous_omask_soft_faster_rcnn_x101_64x4d_fpn_1x'
load_from = 'experiments/iccv21/VGGN_updowncrossattn_predcls_Xcroatt_relcap0.7_faster_rcnn_x101_64x4d_fpn_1x/epoch_17.pth'
resume_from = None
