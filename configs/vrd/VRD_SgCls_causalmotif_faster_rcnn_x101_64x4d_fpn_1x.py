...
evaluation = dict(interval=1, metric='sgcls', relation_mode=True, classwise=True, nogc_thres_num=[10, 70])
# optimizer
...
log_level = 'INFO'
work_dir = './new_experiments/VRD_SgCls_gatecausalmotif_faster_rcnn_x101_64x4d_fpn_1x'
