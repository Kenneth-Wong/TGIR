...
from .approaches import VTransEContext
...
class VTransEHead(RelationHead):
    def __init__(self, **kwargs):
        super(VTransEHead, self).__init__(**kwargs)
        ...
        self.post_emb = nn.Linear(self.hidden_dim, self.context_pooling_dim * 2)
        self.rel_compress = nn.Linear(self.context_pooling_dim, self.num_predicates, bias=False)
